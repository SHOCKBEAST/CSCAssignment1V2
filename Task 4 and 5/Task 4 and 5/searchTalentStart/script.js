$('#search').keyup(function () {
    ...
    var urlForJson = "https://localhost:44352/api/talents";
    ...
    $.getJSON(urlForJson, function (data) {
        ...
        $.each(data, function (key, val) {
            ...
            if ((val.Name.search(myExp) != -1) ||
                ...
                //  console.(shortURL);
                //shortURL.success(function (data) {
                //    console.log(data);
                //    output += '<li>';
                //    output += '<h2>' + val.Name + '</h2>';
                //    output += '<p>' + val.Bio + '</p>';
                //    output += '<img src=' + shortURL + " alt=" + val.Name + '" />';
                //    output += '</li>';
                //    //output += '</ul>';
                //    //$('#update').html(output);
                //});
            ...
            //    var shortURL = ShortLinkBitly(urlForCloudImage + val.ShortName + "_tn.jpg");
            //    output += '<img src=' + shortURL+" alt=" + val.Name + '" />';
            ////    var shortURL = ShortLinkBitly(urlForCloudImage + val.ShortName +"_tn.jpg" );
